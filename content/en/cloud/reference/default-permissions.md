...
{{< alert title="Customizable Permissions" type="info" >}}Default permissions can be easily customized by simply creating your own [keychains](/cloud/concepts/identity-and-access/keychains/#keychains-management) and [roles](/cloud/concepts/identity-and-access/roles).{{< /alert >}}
